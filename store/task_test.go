...
import (
	...
	"github.com/tkr53/go_todo_app/testutil/fixture"
)

func prepareUser(ctx context.Context, t *testing.T, db Execer) entity.UserID {
	t.Helper()
	u := fixture.User(nil)
	result, err := db.ExecContext(ctx, `INSERT INTO user (name, password, role, created, modified)
	VALUES (?, ?, ?, ?, ?)`,
...
func TestRepository_ListTasks(t *testing.T) {
	...
	// entity.Taskを作成する他のテストケースを混ざるとテストが失敗する
